...
( function( $ ) {
	...
	if ('undefined' !== typeof themebeans_pro_L10n) {
		...
		setTimeout(function () {
			$('#accordion-section-essay_pro_typography h3, #accordion-section-essay_pro_colors h3, #accordion-section-pro_layout_content h3, #accordion-section-pro_heroarea_content h3').append(upsellMini);
		}, 200);
